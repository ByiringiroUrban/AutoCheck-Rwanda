...
const benefits: BenefitCard[] = [
  {
    ...
    body: "Spot your perfect vehicle quickly with the patented AutoCheck Score and minimize the risk of buying a vehicle with unseen problems.",
  ...
  },
  {
    ...
    body: "Learn if a vehicle has been reported in an accident, branded a lemon, damaged in a flood, reported repossessed or stolen, and more.",
    href: "/vehiclehistory/vehicle-history-reports",
  },
  {
    eyebrow: "Rest Easy",
    title: "Backed by Experian",
    image: { src: "/images/BuybackProtection.png", alt: "Buyback Protection", width: 178, height: 184 },
    body: "Be confident in your purchase and enjoy access to benefits such as free Buyback Protection for registered, qualified vehicles.",
